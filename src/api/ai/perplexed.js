...
module.exports = function(app) {
    app.get("/ai/perplexity", async (req, res) => {
        const { text, web, academic, social, finance } = req.query;
        ...
        try {
            const source = {
                web: web === 'true' || web === '1',
                academic: academic === 'true' || academic === '1',
                social: social === 'true' || social === '1',
                finance: finance === 'true' || finance === '1'
            };
            ...
            return res.status(500).json({
                status: false,
                creator: "aerixxx",
                message: "Gagal mendapatkan respons dari Perplexity AI"
            });
        }
    });
};